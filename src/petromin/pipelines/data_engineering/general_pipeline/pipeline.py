...
from petromin.pipelines.data_engineering.general_pipeline.raw.pandas import pipeline as raw
from kedro.pipeline import Pipeline, pipeline


def create_pipeline(namespace: str) -> Pipeline:
    """Create the general pipeline until the primary layer."""
    pipelines = pipeline(
        [
            raw.create_pipeline(namespace),
